...
<body>
	<div class="single-content">
		...
		<c:if test="${unauthorizedAction}">
			<div class="alert alert-danger" role="alert">Vous devez vous
				identifier pour accéder à cette page.</div>
		</c:if>

		<c:if test="${loginSuccess}">
			<div class="alert alert-danger" role="alert">Connexion ok</div>
			<c:redirect url="home" />
		</c:if>
